                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Supplier</h5>
                            </div>
                            <hr>
                            <form action="{{ route('supplier.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="no_hp_supplier" name="no_hp_supplier" required>
                                    <small class="text-danger">
