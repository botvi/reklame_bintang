                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Supplier</h5>
                            </div>
                            <hr>
                            <form action="{{ route('supplier.update', $supplier->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-md-12">
                                    ...
                                    <small class="text-danger">
                                        @foreach ($errors->get('nama_supplier') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </small>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="alamat_supplier" name="alamat_supplier"
                                        value="{{ old('alamat_supplier', $supplier->alamat_supplier) }}" required>
                                    <small class="text-danger">
                                        @foreach ($errors->get('alamat_supplier') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </small>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="no_hp_supplier" name="no_hp_supplier"
                                        value="{{ old('no_hp_supplier', $supplier->no_hp_supplier) }}" required>
                                    <small class="text-danger">
                                        @foreach ($errors->get('no_hp_supplier') as $error)
                                            <li>{{ $error }}</li>
                                        @endforeach
                                    </small>
                                </div>
