                ...
                <div class="col-xl-7 mx-auto">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form action="{{ route('pelanggan.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="no_hp_pelanggan" name="no_hp_pelanggan" required>
                                    <small class="text-danger">
